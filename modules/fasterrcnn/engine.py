...
def train_one_epoch(model, optimizer, data_loader, device, epoch, print_freq):
    ...
    info_dict = {"lr": [], "loss_comb": [], "loss_classifier": [], "loss_box_reg": [], "loss_objectness": [], "loss_rpn_box_reg": []}
    ...
    info_dict["total_loss"] = sum(info_dict["loss_comb"])/len(info_dict["loss_comb"])
    return info_dict
